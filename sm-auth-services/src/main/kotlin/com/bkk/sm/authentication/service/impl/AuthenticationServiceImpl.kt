package com.bkk.sm.authentication.service.impl
...
class AuthenticationServiceImpl(
    ...
    override suspend fun login(username: String, password: String): ServerResponse {
    ...
    override suspend fun registerUser(userProfile: UserResource): ServerResponse {
    ...
    override suspend fun registerCompany(company: CompanyResource, user: UserResource?): ServerResponse {
    ...
    private suspend fun doLogin(password: String, smUser: SmUser): ServerResponse {
        ...
        return ServerResponse
            ...
            .bodyValueAndAwait(AuthResponse(token!!, Instant.now(), jwtUtil.expirationTimeInSeconds))
    }
