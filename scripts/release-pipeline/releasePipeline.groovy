...
pipeline {
    ...
    environment {
        GITHUB_PATH = "https://${env.GITHUB_APIKEY}@github.com/kdavid76/sm-authentication.git"
        DEVELOPMENT_CONN_URL = "scm:git:https://${env.GITHUB_APIKEY}@github.com/kdavid76/sm-authentication.git"
    ...
    stages {
        ...
        stage('Push release to GitHub') {
            steps {
                ...
                sh '''
                    git add .
                    git commit -m "SM-AUTHENTICATION: Release ${pomVersion}"
                    git push
                '''
            }
        }
        ...
        stage('Push snapshot to GitHub') {
            steps {
                ...
                sh '''
                    git add .
                    git commit -m "SM-AUTHENTICATION: Next snapshot ${pomVersion}"
                    git push
                '''
            }
        }
